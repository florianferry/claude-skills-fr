...
description: "Quand l'utilisateur veut mettre en place un flux marketing récurrent et autonome, une boucle qu'un agent exécute à intervalle régulier plutôt qu'une tâche ponctuelle. À utiliser aussi quand il mentionne « boucle marketing », « flux marketing récurrent », « automatiser mon marketing », « marketing en pilote automatique », « revue marketing hebdomadaire », « contrôle d'usure des publicités », « rafraîchissement de contenu », « surveillance du churn », « alerte de perte de positions » ou « lance ça toutes les semaines ». Sert à choisir, adapter et planifier une boucle qui orchestre les autres skills marketing. Pour des idées ponctuelles, voir marketing-ideas. Pour la boucle d'expérimentation, voir ab-testing."
metadata:
  version: 1.2.0
---
