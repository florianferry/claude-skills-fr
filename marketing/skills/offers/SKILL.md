---
name: offers
description: "Quand l'utilisateur veut concevoir ou améliorer son offre, c'est-à-dire ce qu'il vend réellement : mise en valeur, empilement de bonus, garantie, rareté et urgence, nom, structure de paiement. À utiliser aussi quand il mentionne « offre », « construire une offre », « offre irrésistible », « empilement de valeur », « garantie », « satisfait ou remboursé », « inversion du risque », « rareté », « urgence », « offre haut de gamme », « productiser une prestation », « nommer une offre », « paiement en plusieurs fois », « offre de repli » ou « pourquoi mon offre ne convertit pas ». Pertinent pour les prestations, agences, formations, accompagnements et le B2B à panier élevé. En SaaS en libre-service, lire pricing d'abord : les paliers et le packaging y font davantage. Pour le niveau de prix, voir pricing. Pour la page qui présente l'offre, voir copywriting. Pour le moment du lancement, voir launch."
metadata:
  version: 1.0.0
---
