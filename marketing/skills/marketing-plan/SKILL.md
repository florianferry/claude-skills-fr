---
name: marketing-plan
description: "Quand l'utilisateur a besoin d'un plan marketing complet, pour un client, une entreprise qu'il conseille ou son propre produit. À utiliser aussi quand il mentionne « plan marketing », « plan de croissance », « go-to-market », « plan AARRR », « plan marketing à 90 jours », « feuille de route marketing sur 12 mois » ou « plan de CMO à temps partagé ». Produit un plan exhaustif en 13 sections structuré par AARRR (acquisition, activation, rétention, recommandation, revenu), calibré sur le budget, l'équipe et le stade de maturité, relié aux jalons de financement à venir, croisé avec la bibliothèque d'idées de marketing-ideas et une grille d'audit de l'existant en 17 sections. Pour le positionnement et l'ICP en amont, voir product-marketing. Pour approfondir une étape, voir onboarding, signup, emails, referrals, pricing."
---
