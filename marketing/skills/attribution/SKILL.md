---
name: attribution
description: "Quand l'utilisateur veut savoir quel levier marketing génère réellement des conversions et du chiffre d'affaires, choisir ou interpréter un modèle d'attribution, ou réconcilier des chiffres qui divergent d'un outil à l'autre. À utiliser aussi quand il mentionne « attribution », « modèle d'attribution », « premier contact ou dernier contact », « multi-touch », « quel canal rapporte vraiment », « mon vrai CAC », « mes tableaux de bord ne disent pas la même chose », « Google dit X mais GA dit Y », « MMM », « incrémentalité », « test d'exposition géographique », « comment nous avez-vous connus », « attribution déclarative », « dark social », ou quand il veut instrumenter l'attribution lui-même. Pour le plan de tracking et les UTM, voir analytics. Pour les pixels et la CAPI des régies, voir ads. Pour le reporting pipeline et CRM, voir revops. Pour l'angle mort de la recherche IA, voir ai-seo."
metadata:
  version: 1.1.0
---
