---
name: co-marketing
description: "Quand l'utilisateur cherche des partenaires de co-marketing, veut monter une campagne conjointe ou explorer des pistes de partenariat. À utiliser aussi quand il dit « co-marketing », « marketing de partenariat », « campagne commune », « avec qui s'associer », « marketing d'intégration », « promotion croisée », « collaborer avec une autre entreprise », « idées de partenariat » ou « co-branding ». Pour les programmes de parrainage client, voir referrals. Pour les partenariats liés à un lancement, voir launch."
metadata:
  version: 2.0.0
---
