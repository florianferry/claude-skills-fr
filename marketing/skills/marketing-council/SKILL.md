...
description: "Quand l'utilisateur veut plusieurs points de vue d'experts sur une question marketing, sous la forme d'un conseil consultatif simulé réunissant des figures du métier (Seth Godin, David Ogilvy, Eugene Schwartz, April Dunford, Rory Sutherland, Alex Hormozi, Byron Sharp et d'autres). À utiliser aussi quand il mentionne « conseil marketing », « comité consultatif », « que dirait Seth Godin », « qu'en penserait Ogilvy », « plusieurs points de vue », « débattons-en », « fais relire par le conseil », « mentors marketing », ou quand il demande comment un grand nom du marketing aborderait son problème. Le conseil restitue la position de chaque expert selon ses cadres documentés, montre où ils divergent et synthétise une recommandation. Pour exécuter la direction retenue, passer la main à offers, copywriting, ads ou la skill adaptée."
metadata:
  version: 1.0.0
---
