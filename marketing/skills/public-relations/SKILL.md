...
description: "Quand l'utilisateur veut de l'aide sur les relations presse, la couverture média gagnée, la prise de contact avec des journalistes ou la stratégie média. À utiliser aussi quand il mentionne « relations presse », « RP », « communiqué de presse », « couverture presse », « contacter un journaliste », « se faire remarquer par la presse », « liste média », « kit presse », « rebond sur l'actualité », « appel à témoins de journaliste », « presse tech », « tribune », « article invité » ou « comment obtenir des retombées presse ». Pour les soumissions en annuaires, voir directory-submissions. Pour un lancement produit, voir launch. Pour les réseaux sociaux, voir social. Pour la prise de contact commerciale à froid, voir cold-email."
metadata:
  version: 1.0.0
---
