...
Les sections 4 et 5 sont adaptées de `stop-slop` (Hardik Pandya, MIT), transposées au français.
...
## 5. Grille de contrôle avant de livrer

Relis le texte à voix haute et vérifie, point par point :

1. Aucune phrase ne « sonne traduite ». Sinon, réécris-la.
2. **Tous les accents et diacritiques** sont présents (jamais d'ASCII à la place : « é » pas « e »,
   « à » pas « a »).
3. **Accords** corrects (relire spécifiquement les participes passés et adjectifs).
4. **Typographie** : espaces insécables, guillemets « », apostrophes ’, pas de tiret cadratin,
   nombres à la française.
5. **Registre** tu/vous homogène d'un bout à l'autre.
6. Aucun tic d'IA ni anglicisme injustifié des listes §1.
7. Aucune structure du §4 laissée en place.
