---
name: prospecting
description: "Quand l'utilisateur veut identifier, qualifier et constituer une liste de prospects à contacter, en SaaS B2B, en B2B généraliste ou auprès de commerces locaux. À utiliser aussi quand il mentionne « prospection », « liste de prospects », « trouver des prospects », « génération de leads », « trouver des entreprises qui », « comptes cibles », « qui viser », « liste outbound », « trouver des clients près de chez moi », « leads qualifiés », « trouver mes premiers clients », « early adopters », « partenaires pilotes », « bêta-testeurs » ou « qui a ce problème ». Couvre la phase de constitution et de qualification de la liste. Pour rédiger la prise de contact ensuite, voir cold-email. Pour une recherche concurrentielle approfondie sur un compte, voir competitor-profiling."
metadata:
  version: 1.1.0
---
