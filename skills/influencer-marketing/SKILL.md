...
description: "Quand l'utilisateur veut travailler avec des influenceurs, des créateurs ou des ambassadeurs : trouver et qualifier les partenaires, structurer les contrats, briefer les créateurs, respecter les obligations de transparence et mesurer le retour. À utiliser aussi quand il mentionne « marketing d'influence », « influenceur », « partenariat créateur », « sponsoring », « sponsoring YouTube ou podcast », « ambassadeur de marque », « programme ambassadeur », « UGC », « influenceurs B2B », « envoi de produit », « combien payer un influenceur » ou « mention obligatoire de partenariat ». Pour la mécanique de rémunération à la performance, voir referrals. Pour l'advocacy portée par la communauté, voir community-marketing. Pour transformer le contenu créateur en publicité, voir ad-creative."
metadata:
  version: 1.0.0
---
