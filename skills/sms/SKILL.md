---
name: sms
description: "Quand l'utilisateur veut concevoir ou optimiser du marketing par SMS ou MMS : séquence de bienvenue, relance de panier abandonné, après-achat, réactivation, envoi promotionnel ou SMS transactionnel et d'authentification. À utiliser aussi quand il mentionne « marketing SMS », « campagne SMS », « séquence SMS », « automatisation SMS », « SMS de panier abandonné », « SMS après achat », « conformité SMS », « numéro court », « opt-in SMS », « faut-il faire du SMS » ou « SMS ou e-mail ». Pour les séquences e-mail, voir emails. Pour la formulation des messages, voir copywriting. Pour les popups de collecte de numéro, voir popups."
metadata:
  version: 1.0.0
---
